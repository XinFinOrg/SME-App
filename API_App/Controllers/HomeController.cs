...
namespace API_App.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult API()
        {
            ...
            // POST METHODE
            requestendpoint = "";
            requestendpoint = Getrequestendpoint + "caseIdentifiers?caseId";

            var httpWebRequest = (HttpWebRequest)WebRequest.Create("http://localhost:82/api/ProjectType/Add");
            httpWebRequest.ContentType = "application/json";
            httpWebRequest.Method = "POST";
            httpWebRequest.Headers.Add("authorization", authorisation);
            httpWebRequest.Headers.Add("Cache-Control", "no-cache");
            using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
            {
                string json = new JavaScriptSerializer().Serialize(new
                {
                    ContractName = "Application Demo Name ONE vb",
                    IsDeleted = false,
                    CreateBy = 1
                });
            ...
            //PUT METHODE
            //var httpWebRequest = (HttpWebRequest)WebRequest.Create("http://localhost:82/api/ProjectType/Update/ID=44");
            //httpWebRequest.ContentType = "application/json";
            ...
            //    string json = new JavaScriptSerializer().Serialize(new
            //    {
            //        ContractName = "Application Update gdfg fdg jfj",
            //        IsDeleted = false,
            //        UpdateBy = 1
            //    });
            ...
            //DELETE METHODE
            //var httpWebRequest = (HttpWebRequest)WebRequest.Create("http://localhost:82/api/ProjectType/Delete/ID=44");
            //httpWebRequest.ContentType = "application/json";
